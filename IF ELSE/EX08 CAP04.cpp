...
int main(void)
{
    ...
    if (r2 == 0 or r3 == 0)
        {
        cout << "\nO valor de A é divisivel por 2 ou 3..." << endl;
    ...
    if (r2 == 0 or r3 == 0)
        {
        cout << "O valor de B é divisivel por 2 ou 3..." << endl;
    ...
    if (r2 == 0 or r3 == 0)
        {
        cout << "O valor de C é divisivel por 2 ou 3..." << endl;
    ...
    if (r2 == 0 or r3 == 0)
        {
        cout << "O valor de D é divisivel por 2 ou 3..." << endl;
